...
public class MyUtil {
	...
	public static String getPageBarWithSearch(int sizePerPage, int blockSize, int totalPage, int currentShowPageNo, String colname, String search, String period, String url) {
		...
		if (pageNo == 1) {
			...
			str_pageNo = "&nbsp;<a href=\""+url+"?currentShowPageNo="+(pageNo-1)+"&sizePerPage="+sizePerPage+"&colname="+colname+"&search="+search+"&period="+period+"\" >"+"<span style='font-size:13pt; font-weight: bolder; color:green;'>[이전]</span></a>&nbsp;"; 
		}
		...
		if (pageNo > totalPage) {
			...
			str_pageNo = "&nbsp;<a href=\""+url+"?currentShowPageNo="+pageNo+"&sizePerPage="+sizePerPage+"&colname="+colname+"&search="+search+"&period="+period+"\" >"+"<span style='font-size:13pt; font-weight: bolder; color:navy;'>[다음]</span></a>&nbsp;"; 
		}
