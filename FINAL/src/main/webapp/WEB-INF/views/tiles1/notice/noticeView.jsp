...
<div class="container">                  
  ...
  <c:if test="${not empty noticevo.previousseq && not empty noticevo.nextseq}">
    <li class="previous"><a href="noticeView.ana?idx=${noticevo.previousseq}">이전글 : ${noticevo.previoussubject}</a></li>
    <li class="next"><a href="noticeView.ana?idx=${noticevo.nextseq}">다음글 : ${noticevo.nextsubject}</a></li>
  </c:if>
